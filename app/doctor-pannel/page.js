...
//                   <th className="text-left py-3 px-6">Reports</th>
//                   <th className="text-left py-3 px-6">Meeting</th>
//                   <th className="text-left py-3 px-6">Prescription</th>
//                 </tr>
//               </thead>
//               <tbody>
...
//                     </td>
//                     <td className="py-4 px-6">{appt.firstName}</td>
//                     <td className="py-4 px-6 italic">{appt.appointmentDate}</td>
...
//                   }))
//                 }
//                 className="px-4 py-2 border border-white/50 bg-white/30 text-black rounded-xl w-full"
//               />
//             </div>
...
//               onClick={async () => {
//                 try {
//                   const meetingLink = generateMeetingLink(selectedPatient._id);

//                   await fetch("/api/updateappointmemt", {
//                     method: "POST",
//                     headers: { "Content-Type": "application/json" },
//                     body: JSON.stringify({
//                       appontmentId: selectedPatient.email,
...
//               className="mt-3 px-6 py-2 bg-gray-600 text-white rounded-xl"
//             >
//               Close
//             </button>
//           </div>

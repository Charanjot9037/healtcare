  ...
  return (
    <div className="min-h-screen flex">
      ...
      <main className="flex-1 bg-gradient-to-br from-white via-purple-100 to-purple-200 p-6 md:p-8">
        {!showModal && (
          <div className="w-full bg-white backdrop-blur-xl shadow-2xl p-8 md:p-12 border border-purple-200 transition-all duration-500 animate-fadeIn">

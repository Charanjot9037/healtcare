...
//           >
//             <Image
//               src={slide.img} // ✅ dynamic image
//               alt={slide.caption}
//               width={1200}
//               height={800}
//               className="w-full h-full object-cover"
//               priority={idx === current} // optimize current slide
//             />
...
//         <h3 className="text-2xl text-purple-600 font-semibold mb-6 text-center">Our Doctors</h3>
...
//               <Link href="/appointment" className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg shadow">
//                 Book Appointment
//               </Link>
//             </div>
//           ))}
...
//           <tbody>
//             {appointment.map((pat) => (
//               <tr key={pat.id} className="border- text-black">
